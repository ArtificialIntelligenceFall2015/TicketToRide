...
public class World {
	...
	/**
	 * This field use for get path by using cities string Ex. City1 c1, City2
	 * c2, List Paths p will represent as: key: c1c2, value: p because of some
	 * of two cities has more than two Path it needs a list of path
	 **/
