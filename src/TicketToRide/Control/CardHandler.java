 ...
 * @author Jun He
 * 
 *         This class's methods work as card's handling behavior
 */
...
public class CardHandler {
	 ...
	 * @return
	 */
	public static HashMap<trainCard, Integer> trainCardCollection(
	...
	/**
	 * get specific amount of color if key no exist, return 0
	 * 
	 * @param player
	 * @param card
	 * @return
	 ...
	 * @return
	 */
	public static int getCollectionAmount(
			HashMap<trainCard, Integer> collection, trainCard card) {
